...
class FavouritesAdapter(private val userFavouritesFood: List<Pair<String, String>>): RecyclerView.Adapter<FavouritesAdapter.FavouritesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavouritesViewHolder {
        val layout = LayoutInflater.from(parent.context).inflate(R.layout.favourites_view_item, parent, false)
